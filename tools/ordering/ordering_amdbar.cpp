// Wrapper for AMDBAR (Approximate Minimum Degree, WITHOUT aggressive absorption)
// Fortran source: external/amdbar.f
// Subroutine: AMDBAR(N, PE, IW, LEN, IWLEN, PFREE, NV, NEXT, LAST, HEAD, ELEN, DEGREE, NCMPA, W)
// Same interface as AMD but skips aggressive absorption — faster, slightly less optimal fill.
                      ...
                      int** perm, int** iperm)
{
    ...
    amdbar_(&N, PE.data(), IW.data(), LEN.data(), &IWLEN, &PFREE,
