// Wrapper for AMDNEW (AMD with aggressive absorption — newer variant)
// Fortran source: external/amdNEW.f
// Subroutine: AMDNEW(N, PE, IW, LEN, IWLEN, PFREE, NV, NEXT, LAST, HEAD, ELEN, DEGREE, NCMPA, W)
// Functionally equivalent to AMD (amd.f) but is the "new" version from the MC47/AMD suite.
                      ...
                      int** perm, int** iperm)
{
    ...
    amdnew_(&N, PE.data(), IW.data(), LEN.data(), &IWLEN, &PFREE,
